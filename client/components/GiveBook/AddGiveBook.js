...
const AddGiveBook = () => {
    ...
    const AddGiveBookInfo = async () =>{
        ...
        await axios({
            method: 'post',
            url:'http://127.0.0.1:8000/api/givebook/',
            data: formField,
        }).then((response) =>{
        ...
        <div >
            ...
            <div className="container">
                <div className="form-group">
                    ...
                    <button className="btn btn-outline-success"  onClick={AddGiveBookInfo}> Добавить </button>
